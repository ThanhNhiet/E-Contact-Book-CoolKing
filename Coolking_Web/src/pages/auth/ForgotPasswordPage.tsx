      ...
      <div className="bg-white rounded-2xl shadow-xl p-8 w-full max-w-md">
        ...
        {!selectedMethod ? (
          ...
          <div className="space-y-4">
            ...
            <button
              disabled
              className="w-full bg-gray-400 cursor-not-allowed text-white font-semibold py-4 px-6 rounded-xl flex items-center justify-center space-x-3"
            >
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="text-center">
                ...
                <div className="text-xs text-gray-300">(Đang bảo trì)</div>
              </div>
            </button>
          ...
          <div className="space-y-6">
            <div>
              ...
              <input
                ...
                placeholder={selectedMethod === 'email' ? 'example@email.com' : '0987654321'}
